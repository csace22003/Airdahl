...
// Uncomment below for launch parameters
 #define LAUNCH_VELOCITY_THRESHOLD 5       // unit: m/s
 #define LAUNCH_HEIGHT_THRESHOLD 15         // unit: m
// // #define APOGEE_ALTITUDE_THRESHOLD 1200.0    // unit: m  DEPRECATED
 #define APOGEE_VELOCITY_THRESHOLD 5.0      // unit: m/s
 #define LANDING_ALTITUDE_THRESHOLD 20       // unit: m
 #define TILT_THRESHOLD 0.35 // unit: radians

// #define LAUNCH_VELOCITY_THRESHOLD -1.0       // unit: m/s
// #define LAUNCH_HEIGHT_THRESHOLD 0.25         // unit: m
// #define APOGEE_ALTITUDE_THRESHOLD 1200.0    // unit: m  DEPRECATED
// #define APOGEE_VELOCITY_THRESHOLD 10.0      // unit: m/s
// #define LANDING_ALTITUDE_THRESHOLD 0.25       // unit: m
// #define TILT_THRESHOLD 0.35 // unit: radians
